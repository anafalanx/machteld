...
description: The public Machteld 0.12.0 commands and their intended composition.
...
`version` and `package require machteld` return `0.12.0`. `manifest` describes the

...
description: The public Machteld 0.10.2 commands and their intended composition.
...
`version` and `package require machteld` return `0.10.2`. `manifest` describes the

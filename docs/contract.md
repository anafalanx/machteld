...
The 0.10.1 artifact targets x64 Windows 10 version 1809 or newer, including
...
package require -exact machteld 0.10.1
```
...
Once loaded, `package require machteld` returns `0.10.1`. Palette commands are in
...
Every full, console-wrapped, and GUI-wrapped 0.10.1 host includes this same static
implementation.
...
0.10.1 and the same machine-control, data, process, and Tcl composition commands,

...
The 0.13.0 artifact targets x64 Windows 10 version 1809 or newer, including
...
package require -exact machteld 0.13.0
```
...
Once loaded, `package require machteld` returns `0.13.0`. Palette commands are in
...
Every full, console-wrapped, and GUI-wrapped 0.13.0 host includes this same static
implementation.
...
0.13.0 and the same machine-control, data, process, and Tcl composition commands,

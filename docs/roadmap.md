...
type: roadmap
title: Roadmap
description: What Machteld 0.10.1 contains and how possible additions are ordered.
...
- Direct opted-in Tcl entry and package `machteld 0.10.1`.
...
selected WMI queries remain candidates. None is promised by 0.10.1. Each needs a

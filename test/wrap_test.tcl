...
check "wrapped console loads package 0.13.0" [string match *version:0.13.0* $text]
...
puts $channel {package require machteld 0.13.0}
...
set text [expr {[file exists $marker] ? [slurp $marker] : ""}]
check "wrapped GUI loads package 0.13.0" [string match *version:0.13.0* $text]

...
check "wrapped console loads package 0.10.2" [string match *version:0.10.2* $text]
...
puts $channel {package require machteld 0.10.2}
...
set text [expr {[file exists $marker] ? [slurp $marker] : ""}]
check "wrapped GUI loads package 0.10.2" [string match *version:0.10.2* $text]

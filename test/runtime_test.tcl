...
set expected {canon child cli csv detach dirs docs hash help http json links log macht manifest mtps pmap pool pty run scope store version wait watch worker wrap}
